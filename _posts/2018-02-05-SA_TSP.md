---
layout: post
title: "Simulated Annealing and vacation planning"
---
...
{% include image.html url="Italy_simann.png" description="<b>Figure 1</b>. Italy, a bunch of cities (red dots) and a couple of weeks of vacation... how do we optimize our time visiting cool places by reducing the travel time between different cities to a minimum?" %}
...
>```
>    cityA     cityB      dist
>0  Bologna  Cagliari  0.474299
>1  Bologna   Catania  0.712602
>2  Bologna  Florence  0.000000
>3  Bologna   Messina  0.657968
>4  Bologna    Milano  0.147987
>```
...
>['Cagliari', 'Napoli', 'Rome', 'Torino', 'Bari', 'Messina', 'Catania', 'Genova', 'Venice', 
> 'Palermo', 'Trento', 'Florence', >'Bologna', 'Milano', 'Trieste', 'Cagliari']
>```

The path of this first random attempt is shown in <b>Figure 3</b>. 

{% include image.html url="random_state.png" description="<b>Figure 3</b>. First initial random guess for the trip of our vacation." %}
...
{% include image.html url="local_optimum.png" description="<b>Figure 4</b>. Local optimum in the paths configuration space. The total length of the path is `3.0766`." %}
...
The best path is a bit shorter than the one we found previously. The new optimal path is shown in <b>Figure 5</b>.

{% include image.html url="global_optimum.png" description="<b>Figure 5</b>. Global optimum in the paths configuration space. The total length of the path is `3.0757`." %}
...
{% include image.html url="global_optimum_both.png" description="<b>Figure 6</b>. Global optimum in the paths configuration space. The total cost of the path is `3.7334`." %}
